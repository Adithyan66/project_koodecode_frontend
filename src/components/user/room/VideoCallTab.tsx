...
//     // Method 1: Try iframe approach first (bypasses AMD issues)
//     const iframe = document.createElement('iframe');
//     iframe.style.display = 'none';
//     iframe.src = `https://${jitsiDomain}/external_api.js`;

//     iframe.onload = () => {
//       // Remove the iframe after loading
//       document.body.removeChild(iframe);

//       // Method 2: Fetch and execute script directly
//       fetch(`https://${jitsiDomain}/external_api.js`)
//         .then(response => response.text())
//         .then(scriptText => {
//           // Remove AMD define calls that cause conflicts
//           const cleanedScript = scriptText.replace(/define\s*\(\s*function/g, 'window.jitsiDefine = function');

//           // Create and execute script
//           const script = document.createElement('script');
//           script.type = 'text/javascript';
//           script.text = cleanedScript;
...
//               loadScriptDirectly(jitsiDomain);
//             }
//           }, 500);
//         })
//         .catch(() => {
...
//   const loadScriptDirectly = (jitsiDomain: string) => {
//     // Final fallback: load script with noConflict approach
//     const script = document.createElement('script');
...
//           setIsJitsiLoaded(true);
//         } else {
//           console.error('JitsiMeetExternalAPI still not available after all loading attempts');
//         }
//       }, 300);
//     };
