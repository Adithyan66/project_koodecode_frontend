...
// import CodeEditor from '../../components/user/codeEditor/CodeEditor';

// // Mock Monaco Editor component (since we can't import the actual Monaco)
...
//             className="w-full h-full bg-gray-900 text-green-400 font-mono text-sm p-4 resize-none border-none outline-none"
//             style={{
...
//         case1: { input: 'nums = [2,7,11,15], target = 9', output: '[0,1]', expected: '[0,1]', passed: true },
//         case2: { input: 'nums = [3,2,4], target = 6', output: '[1,2]', expected: '[1,2]', passed: true },
//         case3: { input: 'nums = [3,3], target = 6', output: '[0,1]', expected: '[0,1]', passed: true }
//     });

//     const [activeTab, setActiveTab] = useState('testcase');

//     const languages = ['Javascript', 'Python', 'Java', 'C++', 'C', 'C#', 'Go', 'Rust'];
...
//                         </div>
//                         <span className="text-xl font-bold">koodecode</span>
//                     </div>
...
//                         <a href="#" className="text-gray-300 hover:text-white">Coins</a>
//                     </nav>
//                 </div>
...
//                             <span className="px-2 py-1 bg-green-600 text-white text-xs rounded">Easy</span>
//                             <span className="px-2 py-1 bg-blue-600 text-white text-xs rounded">AI Assist</span>
//                         </div>
...
//                             <div className="mt-4">
//                                 <h3 className="text-lg font-semibold mb-3">Example 3:</h3>
//                                 <div className="bg-gray-900 p-4 rounded border-l-4 border-green-500">
...
//                                 className={`px-4 py-2 text-sm ${activeTab === 'testcase'
...
//                                 className={`px-4 py-2 text-sm ${activeTab === 'result'
//                                     ? 'text-white border-b-2 border-green-500'
//                                     : 'text-gray-400 hover:text-white'
//                                     }`}
//                             >
...
//                                         <button className="px-3 py-1 bg-gray-700 text-white text-sm rounded">Case 1</button>
//                                         <button className="px-3 py-1 bg-gray-600 text-gray-300 text-sm rounded">Case 2</button>
//                                         <button className="px-3 py-1 bg-gray-600 text-gray-300 text-sm rounded">Case 3</button>
//                                     </div>

//                                     <div className="space-y-3">
//                                         <div>
//                                             <label className="block text-sm text-gray-400 mb-1">nums =</label>
//                                             <div className="bg-gray-900 p-2 rounded text-green-400 font-mono">
//                                                 [2,3,6,4]
//                                             </div>
//                                         </div>
...
//                     {/* Action Buttons */}
//                     <div className="bg-gray-800 border-t border-gray-700 px-4 py-3 flex justify-end space-x-3">
//                         <button
//                             onClick={runCode}
//                             className="flex items-center space-x-2 bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded text-sm transition-colors"
//                         >
//                             <Play size={16} />
//                             <span>Run</span>
//                         </button>
//                         <button
//                             onClick={submitCode}
//                             className="flex items-center space-x-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded text-sm transition-colors"
//                         >
//                             <span>Submit</span>
//                         </button>
//                     </div>
