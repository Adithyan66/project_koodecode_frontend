...
// import { Play, RotateCcw,  CheckCircle, X, Check } from 'lucide-react';
...
//     const [modalSubmissionData, setModalSubmissionData] = useState<ContestSubmissionData | null>(null);
...
//     const SubmissionResultModal: React.FC<SubmissionModalProps> = ({
//         isOpen,
//         onClose,
//         submissionData
//     }) => {
...
//                     {/* Modal Header */}
//                     <div className={`p-6 border-b border-gray-700 ${isAccepted
...
//                                     <div className="text-white font-medium">
//                                         {Math.max(...result.testCaseResults.map(r => r.memoryUsage || 0))}KB
//                                     </div>
//                                 </div>
//                             </div>
//                         </div>
...
//                         {/* Message */}
//                         <div className={`p-4 rounded-lg border-l-4 ${isAccepted
//                             ? 'bg-green-900 bg-opacity-30 border-green-500'
//                             : 'bg-red-900 bg-opacity-30 border-red-500'
//                             }`}>
//                             <p className={`font-medium ${isAccepted ? 'text-green-300' : 'text-red-300'
//                                 }`}>
//                                 {message}
//                             </p>
//                         </div>

//                         {/* Test Case Results (only show failed ones for non-accepted) */}
...
//                                         .slice(0, 3) // Show max 3 failed test cases
//                                         .map((testCase, index) => (
...
//                                                         <div className="bg-gray-900 p-2 mt-1 rounded text-gray-300">
//                                                             {testCase.input}
//                                                         </div>
//                                                     </div>
//                                                     <div>
//                                                         <span className="text-gray-300">Expected:</span>
//                                                         <div className="bg-gray-900 p-2 mt-1 rounded text-green-400">
//                                                             {testCase.expectedOutput}
//                                                         </div>
//                                                     </div>
//                                                     <div>
//                                                         <span className="text-gray-300">Your Output:</span>
//                                                         <div className="bg-gray-900 p-2 mt-1 rounded text-red-400">
...
//                 // Set the submission results for the existing display
//                 setSubmissionResults(submissionData.result);

//                 // Set modal data and show modal
//                 setModalSubmissionData(submissionData);
//                 setShowSubmissionModal(true);

//                 // Toast notifications based on result
//                 if (submissionData.result.overallVerdict === 'Accepted') {
//                     toast.success(`✅ Accepted! ${submissionData.result.testCasesPassed}/${submissionData.result.totalTestCases} test cases passed`);
//                 } else {
//                     toast.error(`❌ ${submissionData.result.overallVerdict} - ${submissionData.result.testCasesPassed}/${submissionData.result.totalTestCases} test cases passed`);
//                 }
